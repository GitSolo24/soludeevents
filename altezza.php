...
<head>
    ...
    <title>Altezza Events Southview</title>
</head>
<body>
    <!DOCTYPE html>
<html lang="en">
...
<h1>You have selected Altezza Events Southview in Laredo, TX!</h1>
...
<div class="mySlides fade">
  ...
  <img src="https://eventective-media.azureedge.net/2550229_lg.jpg" style="width:100%">

</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="https://eventective-media.azureedge.net/2299444_lg.jpg" style="width:100%">
 
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="https://eventective-media.azureedge.net/2558707_md.jpg"  style="width:100%">
</div>
...
<br>
    ...
    <form class="forms" action="registered.php" method="POST" align="left">
...
<!--Date-->
    ...
    <script>    
     ...
     <form name="EventHall" method="POST" class="mb" ><p> Venue Name: 
      ...
      <!--Fort Worth-->
       <option value="4Eleven"> Altezza Events Southview in Laredo, TX </option>
