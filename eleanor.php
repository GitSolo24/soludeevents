...
<h1>You have selected The Eleanor in Austin, TX!</h1>
...
<!--<form action="" method="post" class="date">-->
    ...
    <script>    
     ...
     <form name="EventHall" method="POST" class="mb" ><p> Venue Name: 
      ...
      <!--Fort Worth-->
       <option value="theEleanor">The Eleanor - Austin, TX </option>
