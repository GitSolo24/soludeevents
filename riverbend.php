...
<head>
    ...
    <title>Riverbend Country Club</title>
</head>
<body>
    <!DOCTYPE html>
<html lang="en">
...
<h1>You have selected Riverbend Country Club in Sugarland, TX!</h1>
...
<div class="mySlides fade">
  ...
  <img src="https://www.southtxgolf.com/images/template/showcase9.jpg" style="width:100%">

</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="https://golfadvisor.brightspotcdn.com/dims4/default/a906aff/2147483647/strip/true/crop/663x428+0+7/resize/930x600!/quality/90/?url=https%3A%2F%2Fgolfadvisor.brightspotcdn.com%2F59%2F97%2F0284ea8466609c845e2ae11505f8%2F47463.jpg" style="width:100%">
 
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="https://eventective-media.azureedge.net/2092716_lg.jpg"  style="width:100%">
</div>
...
<!--<form action="" method="post" class="date">-->
    ...
    <script>    
     ...
     <form name="EventHall" method="POST" class="mb" ><p> Venue Name: 
      ...
      <!--Fort Worth-->
       <option value="riverbend"> Riverbend Country Club - Sugarland, TX </option>
