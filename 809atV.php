...
<h1>You have selected the 809 at Vickery in Fort Worth, TX!</h1>
...
<div class="mySlides fade">
  ...
  <img src="https://assets.simpleviewinc.com/simpleview/image/fetch/c_fill,h_651,q_75,w_978/https://assets.simpleviewinc.com/simpleview/image/upload/crm/fortworth/Understated-Modern-Wedding-at-809-at-Vickery-Shaun-Menary-19-of-22-600x400.92183554_large0-5640d1695056a34_5640da28-5056-a348-3a2c166fe03ffce3.jpg" width=100% >

</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="https://assets.simpleviewinc.com/simpleview/image/fetch/c_limit,q_75,w_1200/https://assets.simpleviewinc.com/simpleview/image/upload/crm/fortworth/TSG_809V_9439_a.92183924_large0-5644a79f5056a34_5644ade4-5056-a348-3a7e3a86ee0d6092.jpg" width=100%>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="https://lh3.googleusercontent.com/proxy/fz5B-rOG49-x-nEv-6rMumeqFkBToi4W1TpYjjRFEv7whB_JgzkW1fx46Y4Rq4dIszk7o1SvO4CXsKQ3djWs_L5edWjKE0DNnNaaHHoqMbeqBguFHVReEJAQaA8RZXrMdvjLZA7KMzUZsktUp2mGf0o8CVmrMqE" style=100%>
</div>
...
<!--<form action="" method="post" class="date">-->
    ...
    <script>    
     ...
     <form name="EventHall" method="POST" class="mb" ><p> Venue Name: 
      ...
      <!--Fort Worth-->
       <option value="809atV">809 at Vickery - Fort Worth, TX  </option>
