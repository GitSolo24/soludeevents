...
<head>
    ...
    <title>Buffalo Valley Event Center</title>
</head>
<body>
    <!DOCTYPE html>
<html lang="en">
...
<h1>You have selected Buffalo Valley Event Center in Denton, TX!</h1>
...
<div class="mySlides fade">
  ...
  <img src="https://buffalovalleyeventcenter.com/wp-content/uploads/2015/06/big-home.jpg" style="width:100%">

</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="https://buffalovalleyeventcenter.com/wp-content/uploads/2015/10/Denton_Texas_Wedding_dark_Overlay.jpg?id=2137" style="width:100%">
 
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="https://buffalovalleyeventcenter.com/wp-content/uploads/2017/06/Buffalo_Valley_Texas_front.jpg"  style="width:100%">
</div>
...
<!--Date-->
    ...
    <script>    
     ...
     <form name="EventHall" method="POST" class="mb" ><p> Venue Name: 
      ...
      <!--Fort Worth-->
       <option value="buffaloE">Buffalo Valley Event Center - Denton, TX </option>
